...
<div class="bg-black text-white selection:bg-indigo-500/30">
  ...
  <section class="relative min-h-screen flex items-center overflow-hidden">
    <!-- Background -->
    <div
      class="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(67,56,202,0.15)_0%,rgba(0,0,0,1)_60%)]"
    ></div>
    <div
      class="absolute inset-0 opacity-[0.03] bg-[linear-gradient(to_right,#808080_1px,transparent_1px),linear-gradient(to_bottom,#808080_1px,transparent_1px)] bg-[size:32px_32px]"
    ></div>

    <!-- Glowing orbs -->
    <div
      class="absolute top-20 left-[10%] w-[500px] h-[500px] bg-indigo-600/10 rounded-full blur-[150px] pointer-events-none"
    ></div>
    <div
      class="absolute bottom-20 right-[5%] w-[400px] h-[400px] bg-purple-600/8 rounded-full blur-[120px] pointer-events-none"
    ></div>

    <div
      class="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-0"
    >
      <div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div bind:this={heroContent} class="space-y-8">
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center gap-4">
              <div class="relative shrink-0">
                <div
                  class="h-16 w-16 rounded-full overflow-hidden border-2 border-indigo-500/40 bg-zinc-800 shadow-lg shadow-indigo-900/30 ring-2 ring-zinc-700"
                >
                  {#if profilePhotoUrl}
                    <img
                      src={profilePhotoUrl}
                      alt="Malik Md Apu Rahman"
                      class="h-full w-full object-cover"
                    />
                  {:else}
                    <div
                      class="h-full w-full flex items-center justify-center bg-gradient-to-br from-indigo-600/40 to-purple-600/30"
                    >
                ...
                <span
                  class="absolute -bottom-0.5 -right-0.5 h-4 w-4 rounded-full border-2 border-black bg-emerald-500"
                ></span>
              </div>
              <h1
                class="text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-5xl lg:text-6xl"
              >
                Malik Md Apu Rahman
              </h1>
            </div>
          ...
          <div class="flex flex-wrap items-center gap-3">
            <a
              href="/about"
              class="group inline-flex h-11 items-center justify-center gap-2 rounded-lg bg-indigo-600 px-6 text-sm font-semibold text-white transition-all hover:bg-indigo-500 hover:shadow-lg hover:shadow-indigo-600/20"
            >
              <Play class="h-4 w-4" />
              Watch Introduction
            </a>
            <a
              href="/projects"
              class="group inline-flex h-11 items-center justify-center gap-2 rounded-lg border border-zinc-700 bg-zinc-900/50 px-6 text-sm font-semibold text-white backdrop-blur-sm transition-all hover:border-zinc-500 hover:bg-zinc-800/50"
            >
              View Projects
              <ArrowRight
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex flex-wrap items-center justify-center gap-8 sm:gap-14">
        {#each trustedBy as brand}
          <span
            class="text-lg font-bold tracking-tight text-zinc-600 transition-colors hover:text-zinc-400 sm:text-xl {brand ===
            'fiverr'
              ? 'lowercase'
              : ''}"
          >
      ...
      <div class="grid gap-12 lg:grid-cols-2 items-center">
        ...
        <div class="space-y-6">
          ...
          <p class="text-zinc-400 leading-relaxed">
            ...
            scheduling, attendance, offline sync, reporting and AI-powered
            insights.
          </p>
          ...
          <div class="grid grid-cols-2 gap-3">
            {#each caseStudyFeatures as feature}
              ...
              <div
                class="flex items-center gap-2.5 rounded-lg border border-zinc-800/50 bg-zinc-900/30 px-3 py-2.5 text-sm"
              >
          ...
          <div class="flex flex-wrap gap-3 pt-2">
            <a
              href="/projects/enterprise-workforce-management"
              class="inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-indigo-600 px-5 text-sm font-semibold text-white transition-all hover:bg-indigo-500"
            >
              Explore Case Study
            </a>
            <a
              href="https://www.youtube.com/watch?v=M8YWf6uVqpc"
              target="_blank"
              rel="noopener noreferrer"
              class="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-zinc-700 px-5 text-sm font-medium text-zinc-300 transition-all hover:border-zinc-500 hover:text-white"
            >
        ...
        <div class="relative">
          <div
            class="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4 shadow-2xl shadow-black/40"
          >
            <div
            ...
            <div class="mt-3 flex flex-wrap gap-1.5">
              {#each ["SvelteKit", "Fastify", "Redis", "Socket.IO", "Flutter"] as tech}
                <span
                  class="rounded bg-zinc-800/50 px-2 py-0.5 text-[10px] font-medium text-zinc-400"
                  >{tech}</span
                >
              {/each}
            </div>
